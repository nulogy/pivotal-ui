...
var _flexGrids = require('../flex-grids/flex-grids');
...
var LargeTabs = exports.LargeTabs = function (_mixin$with) {
  ...
  LargeTabs.prototype.render = function render() {
    ...
    var largeScreenClasses = (0, _classnames3.default)(['tab-' + tabType, largeScreenClassName, className]);
    ...
    if (isLeft) {
      ...
      return _react2.default.createElement(
        _flexGrids.Grid,
        (0, _extends3.default)({ className: (0, _classnames3.default)(largeScreenClasses, 'tab-left', 'clearfix') }, props),
        _react2.default.createElement(
          _flexGrids.FlexCol,
          { fixed: true, className: (0, _classnames3.default)((_classnames = {}, _classnames['col-' + tabWidth] = !!tabWidth, _classnames)) },
          actionsNode,
          _react2.default.createElement(_tab_headers2.default, { childArray: childArray, activeKey: activeKey, handleClick: handleClick, isLeft: isLeft, id: id, onSelect: onSelect })
        ),
        _react2.default.createElement(
          _flexGrids.FlexCol,
          null,
    ...
    return _react2.default.createElement(
      'div',
      (0, _extends3.default)({ className: largeScreenClasses }, props),
      actionsNode,
