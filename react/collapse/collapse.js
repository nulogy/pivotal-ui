...
var BaseCollapse = exports.BaseCollapse = function (_React$PureComponent) {
  ...
  BaseCollapse.prototype.render = function render() {
    ...
    var props = (0, _helpers.mergeProps)(others, {
      className: ['pui-collapse', { 'pui-collapse-divider': divider }, 'panel', { 'panel-divider': divider }]
    });
    var expanded = this.state.expanded;
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'div',
        { className: 'pui-collapse-panel-heading panel-heading', onClick: this.handleSelect },
        _react2.default.createElement(
          'div',
          { className: 'pui-collapse-panel-title panel-title', role: 'presentation' },
          this.renderHeader()
        )
      ),
      _react2.default.createElement(
        'div',
        { className: 'pui-collapse-panel panel-collapse' },
        _react2.default.createElement(
          _collapsible.Collapsible,
          { className: 'pui-collapse-panel-body panel-body', expanded: expanded, delay: 200 },
          children
        )
      )
    );
...
var Collapse = exports.Collapse = function (_BaseCollapse) {
  ...
  Collapse.prototype.renderHeader = function renderHeader() {
    ...
    return _react2.default.createElement(
      'div',
      { className: 'pui-collapse-trigger collapse-trigger' },
      _react2.default.createElement(_iconography.Icon, { className: 'pui-collapse-icon collapse-icon', src: iconSrc }),
      header
    );
  };
