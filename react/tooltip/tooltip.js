...
var Tooltip = exports.Tooltip = function (_React$PureComponent) {
  ...
  Tooltip.prototype.render = function render() {
    ...
    var newClasses = (0, _classnames2.default)('pui-tooltip-container', visible ? 'pui-tooltip-container-visible' : 'pui-tooltip-container-hidden', size === 'auto' ? null : 'pui-tooltip-' + size, isSticky ? 'pui-tooltip-hoverable' : null, className);
...
var TooltipTrigger = exports.TooltipTrigger = function (_React$Component) {
  ...
  TooltipTrigger.prototype.render = function render() {
    ...
    var newClasses = (0, _classnames2.default)('pui-tooltip', className, placementClass, theme === 'light' ? 'pui-tooltip-light' : null);
