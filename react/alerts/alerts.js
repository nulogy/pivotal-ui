...
var Alert = function (_React$PureComponent) {
  ...
  Alert.prototype.render = function render() {
    ...
    var props = (0, _helpers.mergeProps)(others, {
      role: 'alert',
      className: (0, _classnames2.default)('alert', 'pui-alert', 'alert-' + bsStyle, 'pui-alert-' + bsStyle, { 'alert-dismissable': dismissable }, { 'pui-alert-dismissable': dismissable })
    });
    ...
    if (dismissable) {
      dismissableColumn = _react2.default.createElement(
        ...
        _react2.default.createElement(
          'button',
          { type: 'button', className: 'btn close pui-close', 'aria-label': closeLabel, onClick: this.handleAlertDismiss },
