...
var UIButton = exports.UIButton = function (_React$Component) {
  ...
  UIButton.prototype.render = function render() {
    ...
    var buttonClasses = {
      className: [(_ref = {
        'pui-btn': true
      }, _ref['pui-btn-' + kind + '-alt'] = alt, _ref['pui-btn-' + kind + '-flat'] = flat, _ref['pui-btn-' + kind] = !alt && !flat, _ref['pui-btn-lg'] = large, _ref['pui-btn-sm'] = small, _ref['pui-btn-icon'] = iconOnly, _ref['pui-btn-icon-right'] = !!icon && iconPosition === 'right', _ref['pui-btn-full'] = fullWidth, _ref['btn'] = true, _ref['btn-' + kind + '-alt'] = alt, _ref['btn-' + kind + '-flat'] = flat, _ref['btn-' + kind] = !alt && !flat, _ref['btn-lg'] = large, _ref['btn-sm'] = small, _ref['btn-icon'] = iconOnly, _ref['btn-icon-right'] = !!icon && iconPosition === 'right', _ref['btn-full'] = fullWidth, _ref)]
    };
    ...
    var buttonContent = _react2.default.createElement(
      'span',
      { className: 'btn-inner-content pui-btn-inner-content' },
      icon,
      btnChildren
    );
